...
- 2026-09-06 : v1.13.1 : attaques à puissance variable (Balayage, Nœud Herbe, Tacle Lourd, Gyroballe...) : les dégâts étaient déjà justes (le moteur utilise le poids / la vitesse de la cible) mais l'affichage montrait "0 BP" ; le détail affiche maintenant la puissance réelle (rawDesc.moveBP) et les listes affichent "var.".
